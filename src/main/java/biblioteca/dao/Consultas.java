...
public class Consultas {
    ...
    public class Obra{
        public static final String FIND_BY_NOME = "SELECT a FROM obra a WHERE UPPER(UNACCENT(titulo)) LIKE UPPER(UNACCENT(:titulo))";
        public static final String FIND_BY_NOME_NA_CATEGORIA = "SELECT a FROM obra a WHERE cod_categoria = :categoria AND UPPER(UNACCENT(titulo)) LIKE UPPER(UNACCENT(:titulo))";
